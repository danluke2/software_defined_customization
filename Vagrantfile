...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "client1" do |client1|
    client1.vm.box = "squanchy/layer4.5"
    client1.vm.box_version = "1.3"
    client1.vm.network "private_network", ip: "10.0.0.30" 
    client1.vm.provider "vmware_fusion" do |vb|
      vb.linked_clone = false
      # Display the GUI when booting the machine
      vb.gui = true
      vb.memory = 8192
  ...
  config.vm.define "client2" do |client2|
    client2.vm.box = "squanchy/layer4.5"
    client2.vm.box_version = "1.3"
    client2.vm.network "private_network", ip: "10.0.0.40" 
    client2.vm.provider "vmware_fusion" do |vb|
      vb.linked_clone = false
      # Display the GUI when booting the machine
      vb.gui = true
      vb.memory = 8192
