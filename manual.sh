...
# Install the spice-vdagent and spice-webdavd packages to enable clipboard and drive sharing between the desktop and UTM.
...
# Added to get the older desktop kernel
sudo apt install linux-image-generic

# Added llows different processes to communicate with each other in a distributed environment
sudo apt install dbus-x1
