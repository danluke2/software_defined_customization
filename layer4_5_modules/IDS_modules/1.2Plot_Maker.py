...
CSV_FILENAME = "1.2dns_query_log.csv"
...
def plot_dns_queries():
    ...
    # Filter out the first 5 seconds of data (minimize white space)
    ...
    # Adjust x-axis labels to start at 0 and go to 75
    x_ticks = range(0, 75, 5)  # Adjusted x-axis values
    ...
    ax.legend(
        sorted_handles, sorted_labels, loc="upper right", frameon=True, fontsize=16
    )
