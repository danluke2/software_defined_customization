...
void modify_buffer_send(struct customization_buffer *send_buf_st, struct customization_flow *socket_flow)
{
    ...
    size_t cust_test_size2 = (size_t)sizeof(cust_test2) - 1;
    ...
    send_buf_st->copy_length = cust_test_size + cust_test_size2 + send_buf_st->length;
    ...
    // Should do another memcpy here
    // Make sure all the offsets are set properly
    // Update the copy length
