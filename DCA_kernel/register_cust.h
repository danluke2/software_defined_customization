...
// Removes each entry in the alerted list while holding lock to prevent access from other functions
// @see list.h for list functions
...
// Added IDS functionality
void ack_alert(char *message, size_t *length, char *request);
