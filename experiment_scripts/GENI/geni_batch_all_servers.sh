...
# first batch
for server in 130.127.215.148 192.12.245.163 204.102.228.173 128.206.119.41 128.171.8.123 128.95.190.50 192.122.236.101
do
...
# second batch
for server in 128.112.170.33 198.82.156.38 72.36.65.68 165.124.51.195 192.86.139.70 140.254.14.100 129.110.253.30
do
  echo "*************** Performing Batch DNS Experiment with Server $server ***************"
  $GENI_SCRIPT_DIR/geni_batch_single_experiment.sh $1 $2 $3 $server $4
...
for server in 8.8.8.8 8.8.4.4 9.9.9.9 149.112.112.112 208.67.222.222 208.67.220.220 1.1.1.1 1.0.0.1 185.228.168.9 185.228.169.9 76.76.19.19 76.223.122.150 94.140.14.14 94.140.15.15
do
  echo "*************** Performing Batch DNS Experiment with Server $server ***************"
