...
python3 $NCO_DIR/deploy_module_helper.py --module "delay_30s" --host 2 --priority 10 --applyNow --activate
...
python3 $NCO_DIR/revoke_module_helper.py --module "delay_30s" --host 2
